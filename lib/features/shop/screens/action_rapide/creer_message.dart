...
class CreerMessage extends StatefulWidget {

  CreerMessage({super.key});
  final List<Contact> _allUsers = contacts;

  @override
  State<CreerMessage> createState() => _CreerMessageState();
}

class _CreerMessageState extends State<CreerMessage> {
  var pageId = 1;
  bool ajouter = true;
