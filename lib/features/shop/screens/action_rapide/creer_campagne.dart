...
class CreerCampagne extends StatefulWidget {

  CreerCampagne({super.key});
  final List<Contact> _allUsers = contacts;

  @override
  State<CreerCampagne> createState() => _CreerCampagneState();
}

class _CreerCampagneState extends State<CreerCampagne> {
  var pageId = 4;
  bool ajouter = true;
